<?php
	...
	echo $new_file;	// Return the file id to the script
	
	
	//涓婁紶鏂囦欢淇℃伅鍐欏叆鏂囦欢
	$data=array(
		'name'=>$_FILES["Filedata"]["name"],  //2222.jpg
		',',
		'type'=>'jpg', //application/octet-stream    
		',',
		'tmp_name'=>$new_file,///tmp/phpn5xBQ4
		',',
		'error'=>$_FILES["Filedata"]["error"],//0
		',',
		'size'=>$_FILES["Filedata"]["size"]//
	);
	$fileopen = fopen('upload.txt','rw');
