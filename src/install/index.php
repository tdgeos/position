...
END;
	...
	$tagtemplates = 'apptagtemplates[template]='.urlencode('<a href="{url}" target="_blank">{subject}</a>').'&'.
		'apptagtemplates[fields][subject]='.urlencode('公告标题').'&'.
		...
		'apptagtemplates[fields][url]='.urlencode('公告地址');
...
if(empty($step)) {
	...
	通过 UCenter Home，作为建站者的您，可以轻松构建一个以好友关系为核心的交流网络，让站点用户可以用一句话记录生活中的点点滴滴；方便快捷地发布公告、上传图片；更可以十分方便的与其好友们一起分享信息、讨论感兴趣的话题；轻松快捷的了解好友最新动态。
...
END;
	...
	</p><p>感谢您选择 UCenter Home。希望我们的努力能为您提供一个强大的社会化网络(SNS)解决方案。通过 UCenter Home，建站者可以轻松构建一个以好友关系为核心的交流网络，让站点用户可以用一句话记录生活中的点点滴滴；方便快捷地发布公告、上传图片；更可以十分方便的与其好友们一起分享信息、讨论感兴趣的话题；轻松快捷的了解好友最新动态。
...
END;
	...
	$ruls[] = "('更新记录', 'updatemood', '1', '0', '3', '1', '3', '0', '3')";
	...
	$ruls[] = "('发表公告', 'publishblog', '1', '0', '3', '1', '5', '0', '5')";
	...
	$ruls[] = "('公告导入', 'blogimport', '0', '0', '1', '0', '10', '0', '0')";
	$ruls[] = "('修改域名', 'modifydomain', '0', '0', '1', '0', '5', '0', '0')";
	$ruls[] = "('公告被删除', 'delblog', '0', '0', '1', '0', '10', '0', '10')";
	...
	$datas[] = "1, '发表自己的第一篇公告', '现在，就写下自己的第一篇公告吧。<br>与大家一起分享自己的生活感悟。', 'blog.php', 3, '', 0, 5, 'image/task/blog.gif'";
	$datas[] = "1, '寻找并添加五位好友', '有了好友，您发的公告、图片等会被好友及时看到并传播出去；<br>您也会在首页方便及时的看到好友的最新动态。', 'friend.php', 4, '', 0, 50, 'image/task/friend.gif'";
