...
$_SGLOBAL['cplang'] = array(
	...
	'feed_comment_blog' => '{actor} 评论了 {touser} 的公告 {blog}',
	...
	'note_blog_comment' => '评论了你的公告 <a href="\\1" target="_blank">\\2</a>',
	'note_blog_comment_reply' => '回复了你的<a href="\\1" target="_blank">公告评论</a>',
	...
	'note_click_blog' => '对你的公告 <a href="\\1" target="_blank">\\2</a> 做了表态',
	...
	'feed_click_blog' => '{actor} 送了一个“{click}”给 {touser} 的公告 {subject}',
	...
	'blog_comment' => '<a href="\\2" target="_blank">\\1 评论了你的公告</a>',
	...
	'blog_comment_reply' => '\\1 回复了你的公告评论',
	...
	'invite_massage' => '<table border="0">
		...
		<td valign="top">\\1</td>
		<td valign="top">
		<h3>Hi，我是\\2，在\\3上建立了个人主页，邀请您也加入并成为好友</h3><br>
		请加入到好友中，你就可以通过我的个人主页了解我的近况，分享我的照片，随时与我保持联系<br>
		<br>
		邀请附言：<br>
		\\4
		<br><br>
	...
	'share_blog' => '分享了一篇公告',
	'note_share_blog' => '分享了你的公告 <a href="\\1" target="_blank">\\2</a>',
	'share_album' => '分享了一个相册',
	...
	'share_tag' => '分享了一个标签',
	'share_tag_blognum' => '现有 {blognum} 篇公告',
	'share_link' => '分享了一个网址',
	'share_video' => '分享了一个视频',
	'share_music' => '分享了一个音乐',
	...
	'feed_blog_password' => '{actor} 发表了新加密公告 {subject}',
	'feed_blog' => '{actor} 发表了新公告',
