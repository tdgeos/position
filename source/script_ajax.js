...
function ajaxmenu(e, ctrlid, isbox, timeout, func) {
	...
	x.get(href, function(s) {
		...
		if(s.indexOf('hideMenu()') == -1) {//娣诲姞鍏抽棴
			s = '<h1>娑堟伅</h1><a href="javascript:hideMenu();" class="float_del" title="鍏抽棴">鍏抽棴</a><div class="popupmenu_inner">' + s + '<div>';
		}
		if(!evaled) {
...
//寰楀埌涓€涓畾闀跨殑hash鍊?渚濊禆浜?stringxor()
