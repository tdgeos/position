...
//Ucenter Home配置参数
$_SC = array();
$_SC['dbhost']  		= 'admin.paihangshuo.com'; //服务器地址
/*
$_SC['dbuser']  		= 'root'; //用户
$_SC['dbpw'] 	 		= ''; //密码
*/
$_SC['dbuser']  		= 'cumt_admin'; //用户
$_SC['dbpw'] 	 		= 'cumt2013'; //密码
$_SC['dbcharset'] 		= 'utf8'; //字符集
$_SC['pconnect'] 		= 0; //是否持续连接
$_SC['dbname']  		= 'discuz'; //数据库
$_SC['tablepre'] 		= 'tdgeos_uchome_'; //表名前缀
...
*/
define('UC_DBUSER', 'discuz'); // UCenter 数据库用户名
define('UC_DBPW', 'discuz2013'); // UCenter 数据库密码

define('UC_DBNAME', 'discuz'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`discuz`.tdgeos_ucenter_'); // UCenter 数据库表前缀
define('UC_TPRE','tdgeos_'); 
define('UC_MEMBER','tdgeos_info_member_');
define('UC_INFO_PIC',"tdgeos_info_pic_");
define('UC_INFO',"tdgeos_info_");
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'X7B8Vb0btebfs7o18bx3JfN1J1h4i4K6R6NaG9r2TaE1L7ca9e5cs4F3X7B1zdG3'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://discuz.paihangshuo.com/uc_server'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
define('UC_CHARSET', 'utf-8'); // UCenter 的字符集
define('UC_IP', '118.244.239.115'); // UCenter 的 IP, 当 UC_CONNECT 为非 mysql 方式时, 并且当前应用服务器解析域名有问题时, 请设置此值
