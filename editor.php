...
<div id="createUrl" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:12px">
	请输入选定文字链接地址:<br/>
	<input type="text" id="insertUrl" name="url" value="http://" class="txt" style="width: 190px;"> <input type="button" onClick="createLink();" name="createURL" value="确定" class="w-bbtn w-bbtn-0 bindbtn ztag" /> <a href="javascript:;" onClick="fHide($('createUrl'));">取消</a>
</div>
<div id="createImg" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:12px">
	请输入图片URL地址:<br/>
	<input type="text" id="imgUrl" name="imgUrl" value="http://" class="txt" style="width: 190px;" /> <input type="button" onClick="createImg();" name="createURL" value="确定" class="w-bbtn w-bbtn-0 bindbtn ztag" /> <a href="javascript:;" onClick="fHide($('createImg'));">取消</a>
</div>
<div id="createSwf" class="eMenu" style="display:none;top:35px;left:26px;width:400px;font-size:12px">
	...
	<input type="text" id="videoUrl" name="videoUrl" value="http://"  class="txt" style="width: 200px;" />
	<input type="button" onClick="createFlash();" name="createURL" value="确定" class="w-bbtn w-bbtn-0 bindbtn ztag" />
