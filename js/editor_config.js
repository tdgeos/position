...
(function () {
	...
	var URL = window.UEDITOR_HOME_URL || '/rsc/js/ueditor/';//修改路径
	...
	UEDITOR_CONFIG = {
        ...
        toolbars:[
                   ['Bold','Underline','StrikeThrough','|','InsertUnorderedList','InsertOrderedList','BlockQuote','|','Link','Unlink','|','Source','FullScreen']
        ],
        //当鼠标放在工具栏上时显示的tooltip提示
        labelMap:{
		'bold':'加粗','underline':'下划线','strikethrough':'删除线','insertunorderedlist':'无序列表','insertorderedlist':'有序列表','blockquote':'引用','link':'超链接','unlink':'取消链接','source':'源码','fullscreen':'全屏'
        },
...
//        ],
        ...
        initialStyle://编辑器内部样式
        	...
        	'html.js-in-ueditor-fullscreen{padding-left:17px;overflow-y:scroll;}' +
        	'html.js-in-ueditor-fullscreen body{width:600px;margin:8px auto;}' +
        	'li{clear:both}' +
        	'*{line-height:1.4;}' +
        	'a{color:#7594b3;}' +
        	'p{margin:10px 0}' +
        ...
        serialize:function () {                              //配置过滤标签
        	return {
        		...
        		whiteList:{
        			        ...
        			        'a':{'$':{'href':1,'target':1,'loftermentionblogid':1},'span':1,'embed':1,'object':1,'br':1,'BR':1,'u':1,'b':1,'strong':1,'strike':1,'img':1},
